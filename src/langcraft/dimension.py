...
class CustomDimension(Serializable):
    def __init__(self,
                 name: str,
        ...
        self.token = ResourceLocToken(GLOBALS.namespace, self.name.split('/'))

    @overload
    def noise(cls,
              name: str,
              type_: _DimensionType,
              preset: Literal['minecraft:overworld', 'minecraft:amplified', 'minecraft:nether', 'minecraft:caves', 'minecraft:end', 'minecraft:floating_islands'],
              biome_source: JSON = JSON(type='multi_noise',
                                        preset='overworld')
              ) -> Self:
        ...
